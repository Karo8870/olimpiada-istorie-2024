  ...
  return (
    <main className='flex flex-col gap-8 px-16 pb-16 pt-36 sm:px-4'>
      ...
      <h1 className='relative z-10 text-[3rem] font-bold text-center md:text-3xl'>
        Program curse speciale RATBV
      </h1>
      <embed src="https://firebasestorage.googleapis.com/v0/b/olimpiada-istorie-2024.appspot.com/o/PROGRAM%20CURSE%20SPECIALE%20RAT.pdf?alt=media&token=6f333662-9c8f-4668-826f-380236b5ccaa" type="application/pdf" height="1000" />
      {/*</div>*/}
      {/*</div>*/}
    </main>
  );
